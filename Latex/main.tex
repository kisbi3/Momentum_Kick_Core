...
The dotted lines are the Momentum-Kick model $f_R \left\langle N_k \right\rangle$ results of heavy-ion collisions, the red color is AuAu at 200 GeV and the black color is PbPb at 2.76 TeV.
And the solid lines and green plots are the proton-proton collisions.
The blue color is previous the Momentum-Kick model of pp at 7 TeV result\cite{Wong_5}, and the green plots are the results in the reference\cite{Hanul}.
And the others, the purple and grey colors, are this paper's results for each of the pp at 13 TeV and 7 TeV.
}
\label{figure:frnk}
\end{figure}
...
Hence, we introduce multiplicity dependence in the $f_R \langle N_k \rangle$ as linearly and we fit the $f_R \langle N_k \rangle$ in the near-side yields.
...
\begin{figure}[ht]
  ...
  The ATLAS experimental results are shown in blue plots \cite{atlas}, and a linearly fitted line for these blue plots, which is used as $f_R \langle N_k \rangle$, is represented by the red line.
  }
...
\begin{table}[ht]
  ...
  $50\leq N_{\text{ch}}^{\text{rec}}<60$   &        & $1.096$ & $0.220(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $60\leq N_{\text{ch}}^{\text{rec}}<70$   &        & $1.117$ & $0.292(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $70\leq N_{\text{ch}}^{\text{rec}}<80$   &        & $1.138$ & $0.308(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $80\leq N_{\text{ch}}^{\text{rec}}<90$   &        & $1.157$ & $0.357(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $90\leq N_{\text{ch}}^{\text{rec}}<100$  & $1.00$ & $1.172$ & $0.422(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $100\leq N_{\text{ch}}^{\text{rec}}<110$ &        & $1.188$ & $0.359(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $110\leq N_{\text{ch}}^{\text{rec}}<120$ &        & $1.212$ & $0.429(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $120\leq N_{\text{ch}}^{\text{rec}}<130$ &        & $1.229$ & $0.507(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \cline{1-1} \cline{3-4} 
  $130\leq N_{\text{ch}}^{\text{rec}}$     &        & $1.233$ & $0.443(-35+0.65N_{\text{ch}}^{\text{rec}})\times10^{-3}$ \\ \hline
  \end{tabular}
  \caption{The results of the physical parameters in the various multiplicities}
  \label{table:variousmulti}
\end{table}

The following figure is $\Delta \phi$ correlation results
